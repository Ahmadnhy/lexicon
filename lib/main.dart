...
void main() async {
  ...
  await Supabase.initialize(
    url: 'https://zekjfepoidolpmthpepn.supabase.co',
    anonKey:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inpla2pmZXBvaWRvbHBtdGhwZXBuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjMwMDEwNzEsImV4cCI6MjA3ODU3NzA3MX0.3t1aZPTeS9U2_fu3jFImuWdS8QmdOycvg-A4mxiKdQ4',
  );
  runApp(const MyApp());
}
